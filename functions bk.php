    ...
    foreach ($tables as $table) {
        ...
        foreach ($machines as $machine) {
            ...
            if($table != 'Period_Cumulative' && $table != 'SHIFT_PATTERN') {
                ...
                //$min = floor($line_stop_val / 60);
                //$sec = $line_stop_val % 60;
                $data[$table][$machine]['shift_line_stop']['value'] = $line_stop_val . ':00';
...
{
    global $db, $tblSettings, $today, $g_period_cumulative;
