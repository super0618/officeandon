                ...
                <div class="row p-5" id="ASSEMBLY">
                    <div class="col-sm-6 col-md-3 p-2" data-machine="ASSY">
                        <fieldset>
                            ...
                            <div class="row">
                                <p class="text1 text-white text-center ">ACUTAL</p>
                            </div>
                            <div class="row">
                        ...
                        for (const machine in result[table]) {
                            ...
                            for (const item in result[table][machine]) {
                                ...
                                if (item === "shift_line_stop") { 
                                    // if (result[table][machine]['shift_line_stop']['value'] != '00:00' && span1.text() != '') {
                                    //     if (result[table][machine]['shift_line_stop']['value'] != span1.text()) {
                                    ...
                                    //     }
                                    // }
                                    span1.text(time_to_str(old_value));
